...
actor_to_ohe = {'bracco':id_matrix[0], 'butler':id_matrix[1], 'gilpin':id_matrix[2], 'harmon':id_matrix[3], 'radcliffe':id_matrix[4], 'vartan':id_matrix[5]}
...
snapshot = cPickle.load(open("snapshot51.pkl"))
...
W = tf.Variable(tf.random_normal([IMG_DIM*IMG_DIM, NUM_LABELS], stddev=0.01))
b = tf.Variable(tf.random_normal([NUM_LABELS], stddev=0.01))
